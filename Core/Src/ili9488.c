...
void write_buffer() {
	...
	HAL_SPI_Transmit(&hspi2, v_buffer, buffer_counter, 10);   ///change by vijaya HAL_SPI_Transmit(&hspi2, &v_buffer, buffer_counter, 10);
	buffer_counter = 0;
}
 ...
 * to the display.
 */
void setwindow(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2) {  ////// change by vijaya [void set_draw_window(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2) {]
